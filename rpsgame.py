...
#  tuples list of win combinations
WIN_LIST_RPSLS = [('KYLE', 'BUTTERS'), ('KYLE', 'KENNY'),  
                  ('CARTMAN', 'KYLE'), ('CARTMAN', 'KENNY'),  
                  ('KENNY', 'BUTTERS'), ('KENNY', 'STAN'),
                  ('STAN', 'CARTMAN'), ('STAN', 'KYLE'), 
                  ('BUTTERS', 'CARTMAN'), ('BUTTERS', 'STAN')] 

#  list of selections
SELECTIONS_LIST_RPSLS = ['KYLE','CARTMAN','KENNY','STAN','BUTTERS']
...
def welcome():
  ...
  while True:
    ...
    "\n* [2] - (South Park) Kyle, Stan, Cartman, Butters Kenny                       *"
    "\n* [3] - Exit - This Will Terminate The Program                                *"
    "\n* SOON - (Companies)                                                          *"                   
    "\n*******************************************************************************"
    "\n Please select an option (1, 2, or 3): ")
    if option == '1' or option == '2':  #  if options 1, 2 or 3 are selected, it will call lets_play function
      lets_play(option)
...
def lets_play(option):
  ...
  if option == '1':  #  if option 1 is selected, it will play Rock + Paper + Scissors game
    ...
    intro = (" Welcome to Rock, Paper, Scissors: South Park Edition!")
    option_help = ("\n This game is simple and goes as following:"
          "\n * You can choose between Kyle, Stan, Cartman, Butters and Kenny."
          "\n * Cartman bullies Kyle and Kenny"
          "\n * Butters kills Stan and Cartman with Kindness"
          "\n * Kenny bothers Butters and Stan"
          "\n * Kyle is better than Butters and Kenny"
          "\n * Stan is more genuine than Cartman and Kyle")
